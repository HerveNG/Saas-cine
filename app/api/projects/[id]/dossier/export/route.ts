...
import { buildDossierHtml } from "../../../../../../../lib/dossier/export";
...
export async function GET(_request: Request, { params }: Params) {
  ...
  const html = buildDossierHtml(project, documents ?? []);
  return new NextResponse(html, {
    status: 200,
    headers: {
      "Content-Type": "text/html; charset=utf-8",
      "Content-Disposition": `attachment; filename="filmfund-${projectId}-dossier.html"`,
