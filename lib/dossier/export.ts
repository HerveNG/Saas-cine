...
function buildPdfPages(project: ExportProject, documents: ExportDocument[], generatedAt: Date) {
...
export function buildDossierPdf(project: ExportProject, documents: ExportDocument[], generatedAt = new Date()) {
  const pages = buildPdfPages(project, documents, generatedAt); const objects: string[] = [];
